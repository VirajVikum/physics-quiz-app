<div>
    ...
    <div class="flex items-center mb-4 ml-10 mt-4">
        <button wire:click="optionSelected({{ $question->id }}, '{{ $question->option1 }}')" 
                ...
                @if(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->answer && $question->option1 === $question->answer) 
                    bg-green-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->option1 && $selectedAnswers[$question->id] !== $question->answer) 
                    bg-red-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] !== $question->answer && $question->option1 === $question->answer) 
                    bg-green-400 
                @endif"
    ...
    <div class="flex items-center mb-4 ml-10 mt-4">
        <button wire:click="optionSelected({{ $question->id }}, '{{ $question->option2 }}')" 
                class="border border-lightBlue hover:border-blue-400 rounded p-1
                @if(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->answer && $question->option2 === $question->answer) 
                    bg-green-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->option2 && $selectedAnswers[$question->id] !== $question->answer) 
                    bg-red-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] !== $question->answer && $question->option2 === $question->answer) 
                    bg-green-400 
                @endif"
                @disabled(isset($completedQuestions[$question->id]))>
            ii.) {{ $question->option2 }}
    ...
    <div class="flex items-center mb-4 ml-10 mt-4">
        <button wire:click="optionSelected({{ $question->id }}, '{{ $question->option3 }}')" 
                class="border border-lightBlue hover:border-blue-400 rounded p-1
                @if(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->answer && $question->option3 === $question->answer) 
                    bg-green-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->option3 && $selectedAnswers[$question->id] !== $question->answer) 
                    bg-red-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] !== $question->answer && $question->option3 === $question->answer) 
                    bg-green-400 
                @endif"
                @disabled(isset($completedQuestions[$question->id]))>
    ...
    <div class="flex items-center mb-4 ml-10 mt-4">
        <button wire:click="optionSelected({{ $question->id }}, '{{ $question->option4 }}')" 
                class="border border-lightBlue hover:border-blue-400 rounded p-1
                @if(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->answer && $question->option4 === $question->answer) 
                    bg-green-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->option4 && $selectedAnswers[$question->id] !== $question->answer) 
                    bg-red-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] !== $question->answer && $question->option4 === $question->answer) 
                    bg-green-400 
                @endif"
                @disabled(isset($completedQuestions[$question->id]))>
            iv.) {{ $question->option4 }}
    ...
    <div class="flex items-center mb-4 ml-10 mt-4">
        <button wire:click="optionSelected({{ $question->id }}, '{{ $question->option5 }}')" 
                class="border border-lightBlue hover:border-blue-400 rounded p-1
                @if(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->answer && $question->option5 === $question->answer) 
                    bg-green-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] === $question->option5 && $selectedAnswers[$question->id] !== $question->answer) 
                    bg-red-400 
                @elseif(isset($selectedAnswers[$question->id]) && $selectedAnswers[$question->id] !== $question->answer && $question->option5 === $question->answer) 
                    bg-green-400 
                @endif"
                @disabled(isset($completedQuestions[$question->id]))>
             v.) {{ $question->option5 }}
